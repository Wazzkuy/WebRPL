...
export default function Footer() {
	const phrase = ["Rekayasa", "Perangkat", "Lunak"];
	const phrase1 = ["HUBUNGI KAMI"];
	return (
		<footer className="w-full min-h-screen padding-x z-30 relative pt-[40px] bg-background flex flex-col justify-between rounded-t-[20px] mt-[-20px]">
			<div className="w-full flex justify-between sm:flex-col xm:flex-col">
				...
				<div className="h-full flex flex-col justify-between sm:w-full xm:w-full w-1/2">
					<div>
						<p className="text-[100px] leading-[115px] lg:text-[130px] lg:leading-[98px] md:text-[100px] md:leading-[75px] sm:text-[74px] sm:leading-[68px] xm:text-[64px] xm:leading-[48px] font-semibold font-FoundersGrotesk text-secondry uppercase">
							...
							<div className="pt-[50px]">
								...
								<div className="flex flex-col gap-y-[10px]">
									<LinkHover
										...
										title={`Jl. Tentara Genie Pelajar No. 26 `}
										href="/"
									/>
								</div>
							</div>
						...
						<div className="pt-[50px] flex gap-x-[20px]">
							...
							<LinkHover
								title="smekda.surabaya@gmail.com"
								href="/"
