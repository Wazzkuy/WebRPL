	...
	return (
		<section className="w-full bg-about padding-y rounded-t-[20px] z-20 relative mt-[-15px]">
			<div className="pl-[50px] sm:px-[20px] xm:px-[20px]">
				...
				&nbsp;adalah suatu disiplin ilmu yang berkaitan dengan proses <span className="sub-heading font-medium font-NeueMontreal link-flash cursor-pointer">
                    <span className="sub-heading font-medium font-NeueMontreal link-flash cursor-pointer">
                    pembuatan, pengembangan, pemeliharaan,dan dokumentasi
                    <span className="sub-heading font-medium font-NeueMontreal link-flash cursor-pointer"> perangkat lunak </span> secara sistematis dan <span>terstruktur</span>
					</span>

					</span><br className="sm:hidden xm:hidden" />
					&nbsp;&nbsp;
					<span className="sub-heading font-medium font-NeueMontreal link-flash cursor-pointer">
					</span>
				</h2>
				...
				<div className="padding-x pb-[50px] w-full flex sm:flex-col xm:flex-col gap-[30px] justify-between">
					<div className="w-[50%] sm:w-full xm:w-full">
						<h3 className="sub-paragraph font-medium text-secondry font-NeueMontreal">
							<b>Tujuan Rekayasa Perangkat Lunak : </b>
						</h3>
					</div>
					<div className="w-[50%] sm:w-full xm:w-full">
