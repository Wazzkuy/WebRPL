...
export const footerItems = [
   {
      id: 1,
      title: "Instagram",
      href: "https://www.instagram.com/rpl.smkn2sby/",
   },
   {
      id: 2,
      title: "Facebook",
      href: "https://www.facebook.com/pages/Smkn2%20surabaya/276444675836207/",
   },
];
...
export const clientsItem = [
   {
      ...
      href: "",
      name: "Pak Suwondo, S.Kom",
      src: client01,
      review: "Lorem ipsum odor amet, consectetuer adipiscing elit. Nisl tellus dictumst potenti torquent ut rhoncus in sociosqu. Aenean faucibus at augue sapien phasellus nec rhoncus integer conubia. Augue suspendisse bibendum hendrerit praesent nibh massa sit posuere aptent. Fames augue nec ad integer orci pharetra. Facilisi metus sociosqu et venenatis fringilla amet platea mollis mollis. Torquent phasellus lectus ex dui volutpat arcu imperdiet potenti. Volutpat odio vestibulum commodo neque enim ullamcorper. Ac lacinia odio neque interdum ultricies ullamcorper ante. Inceptos cras magna montes finibus primis in nisl, risus faucibus.",
      links: [
      ]
   },
   {
...
export const projectProjectItem = [
   {
      id: 1,
      title: "made by : Fiha",
      src: project1,
...
export const aboutPartberItems = [
   {
      ...
      src: web,
      title: "Web Developer",
      para: "Web developer merupakan salah satu lowongan pekerjaan yang paling banyak diminati di bidang IT. Sesuai dengan namanya, web developer adalah pekerjaan yang membangun sebuah website. Terdapat beberapa bahasa pemrograman yang bisa digunakan untuk membangun sebuah website, seperti avascript, Typescript, Go dan lainnya. Menurut data dari Glassdoor, gaji rata-rata seorang web developer berada di kisaran Rp 7.747.430,00 per bulan"
   },
   {
      id: 2,
      src: mobile,
      title: "Mobile Developer",
      para: "Mobile developer merupakan pekerjaan yang berfokus pada pengembangan sebuah aplikasi pada perangkat mobile. Mobile developer menggunakan berbagai bahasa pemrograman dan framework, tergantung pada platform yang mereka kembangkan, seperti Android (menggunakan Java atau Kotlin) atau iOS (menggunakan Swift atau Objective-C). Berdasarkan data dari Glassdoor, gaji rata-rata seorang mobile developer adalah Rp 16.675.000,00 per bulan"
   },
   {
      id: 3,
      src: data,
      title: "Data scientist",
      para: "Data scientist merupakan sebuah pekerjaan yang bertugas untuk engumpulkan dan menganalisis kumpulan data. Baik yang terstruktur maupun tidak. Dari situ, tugas data scientist adalah mengumpulkan pola dan meneliti data secara menyeluruh. Salah satu bahasa pemrograman yang digunakan adalah python. Beberapa tools yang sering digunakan diantaranya adalah MStplotlib, Pytorch, Numpy, Jupyter. Berdasarkan data dari Glassdoor, gaji rata-rata seorang data scientist adalah Rp 12.083.333,00"
   },
   // {
   //    id: 4,
   //    src: toyota,
